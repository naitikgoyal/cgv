...
#include<GL/glut.h>
#include<math.h>
GLfloat a=0,b=5,c=10,d=40,e=45,f=40,g=15,h=20,i=15;
GLfloat a1=310,b1=270,c1=290,d1=290,e1=280,f1=270,g1=290,h1=290,i1=310;
GLfloat x11=470,x12=480,x13=600,x14=620,x15=590,x16=600,x17=650,x18=660,x19=610,x20=630,x21=580,x22=600;
GLfloat y11=270,y12=290,y13=230,y14=250,y15=330,y16=350,y17=450,y18=470,y19=490,y20=510,y21=170,y22=190;
...
void screen()
{
	...
	drawstring(210,540,0.0,"CGV MINI PROJECT(18CSL67) 2021-22");
	drawstring(280,500,0.0,"'AIRCARE'");
	glColor3f(1.0,1.0,1.2);
	drawstring(180,420,0.0,"MRITUNJAY CHOUBEY");
	drawstring(340,420,0,"-1BY19CS085");
	drawstring(180,390,0.0,"NAITIK GOYAL");
	drawstring(340,390,0.0,"-1BY19CS089");
	drawstring(180,360,0.0,"RAKSHA B");
	drawstring(340,360,0.0,"-1BY19CS113");
	glColor3f(1.0,0.0,1.0);
	drawstring(230,320,0.0,"UNDER THE GUIDENCE OF");
	glColor3f(1.0,1.0,1.2);
	drawstring(230,280,0.0,"Assistant Prof: Mr. Muneshwara M S");
	drawstring(230,240,0.0,"Assistant Prof: Mrs. Chethana C");
	glColor3f(0.0,0.8,1.0);
	drawstring(160,130,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	drawstring(230,80,0.0,"ACADEMIC YEAR: 2021-2022");
...
void msg()
{
	...
	drawstring(250,300,0.0,"Hurray!!!");
	drawstring(250,250,0.0,"You have completed this Level");
	drawstring(250,200,0.0,"Press 'L' to start Next Level");
}
void msg1()
{
	glColor3f(1.0,0.6,0.6);
	drawstring(250,300,0.0,"GAME OVER");
...
void msg2()
{
	...
	drawstring(250,280,0.0,"You completed 1 level");
...
void msg3()
{
	glColor3f(1.0,0.6,0.6);
	drawstring(250,320,0.0,"GAME OVER");
	drawstring(250,280,0.0,"You completed 2 levels");
	drawstring(250,250,0.0,"PRESS 'e' TO EXIT");
}
...
void display(void)
{
	...
	if(flag4==1)
	{
		...
		flag2=0;
		flag5=1;
		drawstring(250,330,0.0,"Congratulations");
		drawstring(210,300,0.0,"You have completed all the 3 Levels");
	}
	glFlush();
